...
//            convert("http://patel.myemrhub.com/");
//                localStorage.mahappurl = "http://localhost:9999/ShivamHMSWebApplication/";
//             localStorage.mah = '1';
//             localStorage.appname = "bvc";
//             localStorage.appurl = "http://localhost:9999/ShivamHMSWebApplication/";
//		getIntro(localStorage.appurl);
//             localStorage.appurl = "http://192.168.0.196:9999/ShivamHMSWebApplication/";
//            localStorage.mahappurl = "http://112.196.72.204:809/neosoft/";
//                localStorage.mah = '1';
//                localStorage.appname = "patel";
//                localStorage.appurl = "http://localhost:8084/fh/";
//                localStorage.mahappurl = "http://localhost:8084/fh/";
//                var message = "http://localhost:8084/fh/";
            //  convert("http://patel.myemrhub.com/");
//          /      filename = message + "/mobilejs/patel1.js";
//                filename1 = message + "/mobilejs/PatientLoginSecondScreensql.js";
...
//             localStorage.mah = '1';
//             localStorage.appname = "patel";
//             localStorage.appurl = "http://112.196.72.204:809/neosoft/";
            }
        }
    } catch (err) {
        // alert(err);
...
function getConnection() {
    try {
        if (!CheckConnection()) {
            ...
            hello.greet("bvc", successmah, failuremah);
        }
...
function getConnectionreg() {
    try {
        ...
        localStorage.mahappurl = "http://219.65.73.74:8080/SHIVAM2";
        localStorage.mah = '1';
        localStorage.appname = "bvc";
//        alert(err);
    }
...
//	    alert("responseJson.length "+responseJson.length );
...
//		 alert("responseJson[0]['WEBFORMID'] "+responseJson[0]['WEBFORMID'] );
