...
r(l,[],function(){
    ...
    function e(e,t,n,r){
        ...
        function n(){
            ...
            var i,o=t||{},s;
        for(i in e)"layerX"!==i&&"layerY"!==i&&(o[i]=e[i]);if(o.target||(o.target=o.srcElement||document),e&&a.test(e.type)&&e.pageX===s&&e.clientX!==s){
        ...
        if(i=e[c]){
            if(f=s[i],n){
                for(n=n.split(" "),l=n.length;l--;)if(u=n[l],o=f[u]){
                    if(r)for(d=o.length;d--;)o[d].func===r&&o.splice(d,1);
                    r&&0!==o.length||(delete f[u],t(e,o.fakeName||u,o.nativeHandler,o.capture))
                    }
                }else{
            for(u in f)o=f[u],t(e,o.fakeName||u,o.nativeHandler,o.capture);f={}
        }
        for(u in f)return a;delete s[i];
    try{
        delete e[c]
    }catch(p){
        e[c]=null
...
return{
    ...
    function t(n){
        ...
        if(3==L[V].nodeType){
            if(n=L[V].nodeValue,i=n.substring(L[z],L[q]),e!=O&&(o=L[V],c=L[z],d=L[q]-L[z],0===c&&d>=o.nodeValue.length-1?o.parentNode.removeChild(o):o.deleteData(c,d),L.collapse(F)),e==I)return;
            return i.length>0&&t.appendChild(D.createTextNode(i)),t
            }
            for(o=C(L[V],L[z]),a=L[q]-L[z];o&&a>0;)s=o.nextSibling,l=H(o,e),t&&t.appendChild(l),--a,o=s;
        ...
        function S(e,t){
        var n,i,o,a,s,l;
        for(t!=I&&(n=r()),o=A(e,t),n&&n.appendChild(o),i=$(e),++i,a=L[q]-i,o=e.nextSibling;o&&a>0;)s=o.nextSibling,l=H(o,t),n&&n.appendChild(l),--a,o=s;
...
createHTML:function(e,t,n){
    var r="",i;
    r+="<"+e;
    for(i in t)t.hasOwnProperty(i)&&null!==t[i]&&(r+=" "+i+'="'+this.encode(t[i])+'"');return"undefined"!=typeof n?r+">"+n+"</"+e+">":r+" />"
    },
        ...
        if(e)for(e=t(e,","),v["@"]&&(w=v["@"].attributes,_=v["@"].attributesOrder),n=0,r=e.length;r>n;n++)if(s=k.exec(e[n])){
            if(C=s[1],p=s[2],x=s[3],f=s[5],g={},y=[],c={
                ...
                C&&("="===C&&(c.attributesDefault=c.attributesDefault||[],c.attributesDefault.push({
                    ...
                    name:h,
                    value:E
                }),u.forcedValue=E),"<"===C&&(u.validValues=i(E,"?"))),T.test(h)?(c.attributePatterns=c.attributePatterns||[],u.pattern=d(h),c.attributePatterns.push(u)):(g[h]||y.push(h),g[h]=u)
                }
...
r=r||{},r.validate="validate"in r?r.validate:!0,r.root_name=r.root_name||"body",d.schema=l=l||new t,d.filterNode=function(e){
    ...
    o(a(e),function(e){
        var n;
        for(n=0;n<f.length;n++)if(f[n].name===e)return f[n].callbacks.push(t),void 0;f.push({
            name:e,
            callbacks:[t]
            })
        })
...
if(o=o||{},p={},h={},T=s(i("script,style,head,html,body,title,meta,param"),l.getBlockElements()),O=l.getNonEmptyElements(),P=l.children,S=r.validate,I="forced_root_block"in o?o.forced_root_block:r.forced_root_block,D=l.getWhiteSpaceElements(),R=/^[ \t\r\n]+/,H=/[ \t\r\n]+$/,M=/[ \t\r\n]+/g,L=/^[ \t\r\n]+$/,v=new n({
    ...
    start:function(e,t,n){
        ...
        if(o=S?l.getElementRule(e):{}){
            for(r=d(o.outputName||e,1),r.attributes=t,r.shortEnded=n,b.append(r),s=P[b.name],s&&P[r.name]&&!s[r.name]&&A.push(r),i=f.length;i--;)a=f[i].name,a in t.map&&(E=h[a],E?E.push(r):h[a]=[r]);
    ...
    if(r=S?l.getElementRule(t):{}){
        if(T[t]&&!B){
            ...
            if(n=b.lastChild,n&&3===n.type)if(i=n.value.replace(H,""),i.length>0)n.value=i,n=n.prev;else for(o=n.prev,n.remove(),n=o;n&&3===n.type;)i=n.value,o=n.prev,(0===i.length||L.test(i))&&(n.remove(),n=o),n=o
                }
                if(B&&D[t]&&(B=!1),(r.removeEmpty||r.paddEmpty)&&b.isEmpty(O))if(r.paddEmpty)b.empty().append(new e("#text","3")).value="\xa0";
            ...
            function t(e){
                ...
                if(n)n(e);
                    ...
                    if(s=e.name,l=e.shortEnded,c=e.attributes,a&&c&&c.length>1){
                        for(f=[],f.map={},m=r.getElementRule(e.name),p=0,h=m.attributesOrder.length;h>p;p++)d=m.attributesOrder[p],d in c.map&&(u=c.map[d],f.map[d]=u,f.push({
                            name:d,
                            value:u
                        }));
                        for(p=0,h=c.length;h>p;p++)d=c[p].name,d in f.map||(u=c.map[d],f.map[d]=u,f.push({
                            name:d,
                            value:u
                        }));
                        c=f
...
return e
    ...
    return function(r,i){
        function o(e){
            ...
            function a(t){
            var n,r;
            n=t.screenX-E,r=t.screenY-k,M=n*N[2]+R,L=r*N[3]+A,M=5>M?5:M,L=5>L?5:L,(e.modifierPressed(t)||"IMG"==x.nodeName&&0!==N[2]*N[3])&&(M=Math.round(L/B),L=Math.round(M*B)),b.setStyles(w,{
                width:M,
                height:L
            }),N[2]<0&&w.clientWidth<=M&&b.setStyle(w,"left",S+(R-M)),N[3]<0&&w.clientHeight<=L&&b.setStyle(w,"top",T+(A-L)),H||(i.fire("ObjectResizeStart",{
                target:x,
                width:R,
                height:A
            }),H=!0)
            ...
            function e(e,t){
                ...
                H=!1,e("width",M),e("height",L),b.unbind(D,"mousemove",a),b.unbind(D,"mouseup",s),P!=D&&(b.unbind(P,"mousemove",a),b.unbind(P,"mouseup",s)),b.remove(w),O&&"TABLE"!=x.nodeName||l(x),i.fire("ObjectResized",{
                target:x,
                width:M,
                height:L
            }),i.nodeChanged()
            ...
            function l(e,t,n){
            var r,l,d,u,f;
            r=b.getPos(e,i.getBody()),S=r.x,T=r.y,f=e.getBoundingClientRect(),l=f.width||f.right-f.left,d=f.height||f.bottom-f.top,x!=e&&(m(),x=e,M=L=0),u=i.fire("ObjectSelected",{
                target:e
            }),o(e)&&!u.isDefaultPrevented()?C(_,function(e,r){
                function o(t){
                    H=!0,E=t.screenX,k=t.screenY,R=x.clientWidth,A=x.clientHeight,B=A/R,N=e,w=x.cloneNode(!0),b.addClass(w,"mce-clonedresizable"),w.contentEditable=!1,w.unSelectabe=!0,b.setStyles(w,{
                        left:S,
                        top:T,
                        margin:0
                    }),w.removeAttribute("data-mce-selected"),i.getBody().appendChild(w),b.bind(D,"mousemove",a),b.bind(D,"mouseup",s),P!=D&&(b.bind(P,"mousemove",a),b.bind(P,"mouseup",s))
                    }
                    var c,u;
                return t?(r==t&&o(n),void 0):(c=b.get("mceResizeHandle"+r),c?b.show(c):(u=i.getBody(),c=b.add(u,"div",{
                    ...
                    left:l*e[0]+S-c.offsetWidth/2,
                    top:d*e[1]+T-c.offsetHeight/2
                    }),void 0)
    ...
    function t(t){
        function a(t,n){
            ...
            for(n=n||c,r=new e(n,f.getParent(n.parentNode,f.isBlock)||p);h=r[t?"prev":"next"]();){
                if(3===h.nodeType&&h.nodeValue.length>0)return c=h,d=t?h.nodeValue.length:0,i=!0,void 0;
        ...
        if(c=r[(t?"start":"end")+"Container"],d=r[(t?"start":"end")+"Offset"],m=f.schema.getNonEmptyElements(),9===c.nodeType&&(c=f.getRoot(),d=0),c===p){
            if(t&&(h=c.childNodes[d>0?d-1:0],h&&(g=h.nodeName.toLowerCase(),m[h.nodeName]||"TABLE"==h.nodeName)))return;
...
if(m)if(o)o.nodeType?(y=I.createRng(),y.setStartBefore(o),y.setEndAfter(o),u(T(y,h),null,!0)):u(o,null,!0);
    else if(b&&m.inline&&!I.select("td.mce-item-selected,th.mce-item-selected").length)D("apply",t,n);
    else{
...
function h(e,t,n){
    ...
    e=T(e,p,G),h.split&&(t=L(e,G),n=L(e),t!=n?(/^(TR|TD)$/.test(t.nodeName)&&t.firstChild&&(t="TD"==t.nodeName?t.firstChild||t:t.firstChild.firstChild||t),t=S(t,"span",{
        ...
        id:"_end",
        "data-mce-type":"bookmark"
    }),l(t),l(n),t=d(G),n=d()):t=n=l(t),e.startContainer=t.parentNode,e.startOffset=q(t),e.endContainer=n.parentNode,e.endOffset=q(n)+1),W.walk(e,function(e){
        et(e,function(e){
...
function m(e,t,n){
    ...
    function i(e,t,i){
        ...
        if(s)if(s.length===X){
            ...
            }else for(l=0;l<s.length;l++)if("attributes"===i?I.getAttrib(e,s[l]):_(e,s[l]))return t;return t
    }
    var o=c(t),a,s,l;
if(o&&e)for(s=0;s<o.length;s++)if(a=o[s],x(e,a)&&i(e,a,"attributes")&&i(e,a,"styles")){
    if(l=a.classes)for(s=0;s<l.length;s++)if(!I.hasClass(e,l[s]))return;return a
    }
}
function v(e,t,n){
    function r(n){
    ...
    function s(e){
        ...
        for(;;){
            ...
            for(o=i[a];o;o=o[a])if(!H(o)&&!k(o)&&!t(o))return i;if(i.parentNode==s){
                r=i;
                break
            }
            i=i.parentNode
    ...
    if(3===t.nodeType){
        ...
        }else if(V(l))break;return d?(n=i?0:d.length,{
    container:d,
    offset:n
}):void 0
}
function u(e,r){
    var i,a,s,l;
    for(3==e.nodeType&&0===e.nodeValue.length&&e[r]&&(e=e[r]),i=o(e),a=0;a<i.length;a++)for(s=0;s<n.length;s++)if(l=n[s],!("collapsed"in l&&l.collapsed!==t.collapsed)&&I.is(i[a],l.selector))return i[a];return e
    }
    function f(e,t){
    var r;
    if(n[0].wrapper||(r=I.getParent(e,n[0].block)),r||(r=I.getParent(3==e.nodeType?e.parentNode:e,i)),r&&n[0].wrapper&&(r=o(r,"ul,ol").reverse()[0]||r),!r)for(r=e;r[t]&&!V(r[t])&&(r=r[t],!w(r,"br")););
    return r||e
    }
...
function R(e,t,n,r){
    ...
    if("all"!=e.remove)for(et(e.styles,function(e,i){
        ...
        }),o=I.getAttribs(n),i=0;i<o.length;i++)if(0!==o[i].nodeName.indexOf("_"))return K;return"none"!=e.remove?(A(n,e),G):void 0
}
function A(e,t){
    function n(e,t,n){
    ...
    else if(e=l(F.getStart()),!e)for(;e=I.get(y);)u(e,!1)
        }
        function f(){
    var e,t,r,i,s,u,f;
    ...
    for(t=e.startContainer,r=e.startOffset,d=t,3==t.nodeType&&((r!=t.nodeValue.length||t.nodeValue===j)&&(l=!0),d=d.parentNode);d;){
        ...
        if(u)if(l)s=F.getBookmark(),e.collapse(!0),e=T(e,c(n),!0),e=W.split(e),h(n,o,e),F.moveToBookmark(s);
        else{
        for(m=a(),d=m,p=f.length-1;p>=0;p--)d.appendChild(I.clone(f[p],!1)),d=d.firstChild;
    ...
    return function(t){
        function r(r){
            function d(e){
                ...
                function h(e){
                var t=k,r,o,s;
                if(r=e||"TABLE"==L?i.create(e||P):T.cloneNode(!1),s=r,a.keep_styles!==!1)do if(/^(SPAN|STRONG|B|EM|I|FONT|STRIKE|U)$/.test(t.nodeName)){
            ...
            function y(){
            for(var t=new e(k,T),n;n=t.next();)if(c[n.nodeName.toLowerCase()]||n.length>0)return!0
                }
                function b(){
            var e,t,r;
    ...
    return function(e){
        function t(){
            ...
            if(C=n.forced_root_block,t&&1===t.nodeType&&C){
                ...
                }else l.item&&(t=l.item(0),l=e.getDoc().body.createTextRange(),l.moveToElementText(t)),v=l.parentElement().ownerDocument===e.getDoc(),y=l.duplicate(),y.collapse(!0),d=-1*y.move("character",m),y.collapsed||(y=l.duplicate(),y.collapse(!1),f=-1*y.move("character",m)-d);
...
n.forced_root_block&&e.on("KeyUp NodeChange",t)
    ...
    o(this,{
        ...
        mceInsertContent:function(t,r,i){
            ...
            if(/^ | $/.test(i)&&(i=o(i)),a=n.parser,s=new e({},n.schema),b='<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;</span>',f={
                ...
                },u=a.parse(i,f),v=u.lastChild,"mce_marker"==v.attr("id"))for(p=v,v=v.prev;v;v=v.walk(!0))if(3==v.type||!x.isBlock(v.name)){
    ...
    for(u in e)f=e[u],d[u]="function"==typeof f&&c[u]?s(u,f):f;return t.prototype=d,t.constructor=t,t.extend=i,t
    },t
    ...
    function n(e){
        ...
        match:function(e,n){
            ...
            for(n=n||this._selectors,r=0,i=n.length;i>r;r++){
                for(s=n[r],a=s.length,m=e,h=0,o=a-1;o>=0;o--)for(d=s[o];m;){
                    for(d.psuedo&&(p=m.parent().items(),u=t.inArray(m,p),f=p.length),l=0,c=d.length;c>l;l++)if(!d[l](m,u,f)){
                        l=c+1;
                        break
                    }
                    if(l===c){
...
return s
    ...
    on:function(e,t){
        ...
        var r=this,o,a,s,l;
    if(t)for("string"==typeof t&&(t=n(t)),s=e.toLowerCase().split(" "),l=s.length;l--;)e=s[l],o=r._bindings,o||(o=r._bindings={}),a=o[e],a||(a=o[e]=[]),a.push(t),i[e]&&(r._nativeEvents?r._nativeEvents[e]=!0:r._nativeEvents={
        name:!0
...
postRender:function(){
    ...
    for(var c in e._aria)e.aria(c,e._aria[c]);e.fire("postrender",{},!1)
    },
scrollIntoView:function(e){
    function t(e,t){
        var n,r,i=e;
...
return l
    ...
    r=r||{},l=function(n){
        var l=t(),p,h;
        n.preventDefault(),s=n.button,p=i(),u=n.screenX,f=n.screenY,h=window.getComputedStyle?window.getComputedStyle(p,null).getPropertyValue("cursor"):p.runtimeStyle.cursor,o=a.createElement("div"),e.css(o,{
            position:"absolute",
            top:0,
            left:0,
            width:l.width,
    ...
    function t(t,n,r){
        ...
        return f=e.getViewPort(),o=e.getPos(n),a=o.x,s=o.y,t._fixed&&(a-=f.x,s-=f.y),i=t.getEl(),l=i.offsetWidth,c=i.offsetHeight,d=n.offsetWidth,u=n.offsetHeight,r=(r||"").split(""),"b"===r[0]&&(s+=u),"r"===r[1]&&(a+=d),"c"===r[0]&&(s+=Math.round(u/2)),"c"===r[1]&&(a+=Math.round(d/2)),"b"===r[3]&&(s-=c),"r"===r[4]&&(a-=l),"c"===r[3]&&(s-=Math.round(c/2)),"c"===r[4]&&(a-=Math.round(l/2)),{
            x:a,
            y:s,
            w:l,
            h:c
...
return d.hideAll=function(){
    ...
    return function(t){
        function n(){
            if(!h)if(h=[],u.find)u.find("*").each(function(e){
                e.canFocus&&h.push(e.getEl())
                });else for(var e=u.getEl().getElementsByTagName("*"),t=0;t<e.length;t++)e[t].id&&e[t]&&h.push(e[t])
                }
                function r(){
            ...
            function d(){
            var e,r;
            for(r=i(t.root.getEl()),n(),e=h.length;e--;)if("toolbar"==r&&h[e].id===m)return h[e].focus(),void 0;h[0].focus()
            }
...
return t
    ...
    return function(a){
        ...
        if(n.collapsed||(e=!0),l=n[(e?"start":"end")+"Container"],c=n[(e?"start":"end")+"Offset"],3==l.nodeType&&(r=I.getParent(n.startContainer,I.isBlock),e&&(r=I.getNext(r,I.isBlock)),!r||!t()&&n.collapsed||(i=I.create("em",{
            id:"__mceDel"
        }),D(o.grep(r.childNodes),function(e){
            i.appendChild(e)
            ...
            for(s=F.getBookmark();d=I.get("__mceDel");)I.remove(d,!0);
            F.moveToBookmark(s)
            }
        }
...
function x(){
    ...
    a.on("keydown",function(t){
        ...
        if(n=t.keyCode==O,!c(t)&&(n||t.keyCode==P)&&!e.modifierPressed(t)&&(r=F.getRng(),i=r.startContainer,o=r.startOffset,d=r.collapsed,3==i.nodeType&&i.nodeValue.length>0&&(0===o&&!d||d&&o===(n?0:1)))){
            ...
            u=a.schema.getNonEmptyElements(),t.preventDefault(),s=I.create("br",{
                id:"__tmp"
            }),i.parentNode.insertBefore(s,i),a.getDoc().execCommand(n?"ForwardDelete":"Delete",!1,null),i=F.getRng().startContainer,l=i.previousSibling,l&&1==l.nodeType&&!I.isBlock(l)&&I.isEmpty(l)&&!u[l.nodeName.toLowerCase()]&&I.remove(l),I.remove("__tmp")
            }
        })
}
function N(){
    ...
    return{
        fire:function(e,i,o){
            ...
            if(e=e.toLowerCase(),i=i||{},i.type=e,i.target||(i.target=a),i.preventDefault||(i.preventDefault=function(){
                ...
                },i.isDefaultPrevented=t,i.isPropagationStopped=t,i.isImmediatePropagationStopped=t),a[r]&&(s=a[r][e]))for(l=0,c=s.length;c>l&&(s[l]=d=s[l],!i.isImmediatePropagationStopped());l++)if(d.call(a,i)===!1)return i.preventDefault(),i;if(o!==!1&&a.parent)for(u=a.parent();u&&!i.isPropagationStopped();)u.fire(e,i,!1),u=u.parent();
            return i
            },
        on:function(e,t){
            var n=this,o,a,s,l;
        ...
        render:function(){
            function e(){
                ...
                n.language&&"en"!=n.language&&(n.language_url=t.editorManager.baseURL+"/langs/"+n.language+".js"),n.language_url&&e.add(n.language_url),n.theme&&"function"!=typeof n.theme&&"-"!=n.theme.charAt(0)&&!k.urls[n.theme]&&k.load(n.theme,"themes/"+n.theme+"/theme"+i+".js"),C.isArray(n.plugins)&&(n.plugins=n.plugins.join(" ")),R(n.external_plugins,function(e,t){
                    ...
                    if(e=H(e),e&&!S.urls[e])if("-"==e.charAt(0)){
            ...
            if(!L.domLoaded)return E.bind(window,"ready",function(){
                t.render()
                }),void 0;
...
setContent:function(e,t){
    ...
    return t=t||{},t.format=t.format||"html",t.set=!0,t.content=e,t.no_events||n.fire("BeforeSetContent",t),e=t.content,P||0!==e.length&&!/^\s+$/.test(e)?("raw"!==t.format&&(e=new o({},n.schema).serialize(n.parser.parse(e,{
        isRootContent:!0
        }))),t.content=H(e),n.dom.setHTML(r,t.content),t.no_events||n.fire("SetContent",t),n.settings.content_editable&&document.activeElement!==n.getBody()||n.selection.normalize(),t.content):(i=n.settings.forced_root_block,e=i&&n.schema.isValidChild(r.nodeName.toLowerCase(),i.toLowerCase())?"<"+i+'><br data-mce-bogus="1"></'+i+">":'<br data-mce-bogus="1">',r.innerHTML=e,n.selection.select(r,!0),n.selection.collapse(!0),n.fire("SetContent",t),void 0)
    },
getContent:function(e){
...
_isHidden:function(){
    ...
    function n(r){
        ...
        s.on("init",function(){
            ...
            s.selection.restoreRng&&(s.selection.setRng(s.selection.restoreRng),s.selection.restoreRng=null),e!=s&&(e&&e.fire("blur",{
                focusedEditor:s
            }),s.fire("focus",{
                blurredEditor:e
    ...
    var c=n.DOM,d=o.explode,u=o.each,f=o.extend,p=0,h,m={
        majorVersion:"4",
        minorVersion:"0",
    ...
    init:function(t){
        ...
        o.settings=t,c.bind(window,"ready",function(){
            var l,h;
            if(r(t,"onpageload"),t.types)return u(t.types,function(r){
...
return r
    ...
    return e.extend({
        init:function(e){
            ...
            e.spellcheck=!1,r=n.settings.file_browser_callback,r&&(e.icon="browse",e.onaction=function(){
                ...
                myFileBrowser(t.getEl("inp").id,t.getEl("inp").value,e.filetype,window)
                }),t._super(e)
            }
        })
}),r(At,[mt],function(e){
    ...
    return e.extend({
        recalc:function(e){
            ...
            if(x={},x[E]=0>u?i[E]-u+i[B]:i[R]-u+i[B],x[P]=_+i[W],x[H]=i[R]-u,x[z]=_,x.minW=U(x.minW,i.maxW),x.minH=U(x.minH,i.maxH),x.minW=V(x.minW,i.startMinWidth),x.minH=V(x.minH,i.startMinHeight),!i.autoResize||x.minW==i.minW&&x.minH==i.minH){
                for(C=u/d,t=0,n=v.length;n>t;t++)p=v[t],h=p.layoutRect(),b=h[S],y=h[E]+Math.ceil(h.flex*C),y>b?(u-=h[S]-h[E],d-=h.flex,h.flex=0,h.maxFlexSize=b):h.maxFlexSize=0;
    ...
    function s(e){
        ...
        return c=n.settings.preview_styles,c===!1?"":(c||(c="font-family font-size font-weight text-decoration text-transform color background-color border border-radius"),(e=n.formatter.get(e))?(e=e[0],r=e.block||e.inline||"span",i=a.create(r),d(e.styles,function(e,n){
            ...
            position:"absolute",
            left:-65535
        }),n.getBody().appendChild(i),l=a.getStyle(n.getBody(),"fontSize",!0),l=/px$/.test(l)?parseInt(l,10):0,d(c.split(" "),function(e){
