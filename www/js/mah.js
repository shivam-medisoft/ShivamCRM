...
//        }catch (err){
//          localStorage.mahappurl = "http://182.71.99.38:9999/shivam";
//             localStorage.mah = '1';
//             localStorage.appname = "mah";
//             localStorage.appurl = "http://182.71.99.38:9999/shivam";
...
function getConnectionreg() {
    try {
        if (!CheckConnection()) {
            ...
            hello.greet("mah", successmahreg, failuremahreg);
        }
