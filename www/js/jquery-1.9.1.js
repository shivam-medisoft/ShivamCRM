...
// setTimeout(function(){
//         chekgoogle();
////      document.addEventListener("deviceready", pcheckconn, false);
//     
//      	  },2000);
//  }catch(err){
////      pcheckconn();
...
//    debugger;
//
//if (!CheckConnection()) {//returns false
// proccessconn(0);
//}else{
//    proccessconn(1);  
//}
...
// }
//  
//function proccessconn(conn){
//   var filenm=getCurentFileName();
//    if(filenm==='PatientLoginSecondScreen.html' || filenm==='index_1.html' || filenm==='patel_index.html' || filenm==='fh_index.html' 
//	       || filenm==='belve_index.html' || filenm==='mah_index.html'|| filenm==='ankura_index.html'
//	       || filenm==='emr.html' || filenm==='patel.html'  || filenm==='belve.html'
//	       || filenm==='ankura.html' || filenm==='mah.html' || filenm==='fh.html' || 
//	        filenm==='belve.html' || filenm==='AppIntro.html' ||  filenm==='Entrence.html'
//		 || filenm==='addusers1.html' ){
//	   if(conn==0){
//	       showAlertForNotConn();
// 
//	   }
...
function onDeviceReadyReg() {
    ...
    }else if (localStorage.appname === "mehta") {

        senderid = "412354974761";
    }else if (localStorage.appname === "smf") {

        senderid = "759405471540";
    }
    else{
...
//        }
                ...
                var subtitle = data.additionalData.subtitle;
...
//		alert("notificationsdata.foreground"+notificationsdata.foreground+"localStorage.appurl"+localStorage.appurl);
              if(notificationsdata.foreground===true){
                    jnotifymsgforgnd(notificationsdata.notifymsg,subtitle);
                }else{
...
//    if(filenm === "patel_index.html" || 
//	    filenm === "fh_index.html" || filenm === "ankura_index.html" ||
//	     filenm === "belve_index.html" ||filenm === "mah_index.html" || filenm === "ankura_index1.html" ){
//	 
//
//	   }else{
//	       	document.addEventListener("deviceready", onDeviceReadyReg, false);
//	   } 
                                                ...
                                                function jnotifymsgforgnd(msg, subtitle) {
                                                debugger;
                                                        var exitappname = "";
                                                        var exitappname = "Shivam CRM";
                                                        var exitappicon = "CRMicons/android/icon.png";
                                                        if (localStorage.appname === 'fernandez') {
   ...
   try {
                                       ...
                                       var url=localStorage.ipadrs+"/mobilejs/NotificationPopup.css";
                                              var urlexist=   UrlExists(url);
                                              if(urlexist==false){
                                                var cntn = 0;
                                                ...
                                                if (cntn == 0){
                                             $('<link href="css/NotificationPopup.css" rel="stylesheet" type="text/css"/>').appendTo("head");
                                                 }
                                                ...
                                                if (cntn == 0){
                                                loadcssfile("NotificationPopup.css");
                                                }
                                            }
                                                playBeepn();
                                                        ...
                                                        $(function () {   var blue = document.getElementById('dynamicdiv');
                                                ...
                                                playBeepn();
                                                        navigator.notification.alert(
                                                                msg, // message
                                                                onConfirmn, // callback to invoke with index of button pressed
                                                                exitappname, // title
                                                        ["Ok"]         // buttonLabels
                                                                );
                                                } catch (err) {
...
function jclosepopnotify(){
     event.stopPropagation();
    event.preventDefault();
      $('#dynamicdiv').slideUp("slow");
} 
function onConfirmn(buttonIndex) {
    return;
}
 function playBeepn() {
    try{
...
function getUnreadNotifications(){
    ...
    if(localStorage.appname !== "dashboard"){
       userid = localStorage.mrno;
    }else{
        userid = localStorage.userid;
    }
    $.ajax({
       url : localStorage.ipadrs+"/NotificationReadUP?type=readflag&userid="+userid,
        dataType: 'json',
        success: function (responseJson) {
            var badgecount = responseJson[0]["CNT"];
            if(badgecount === "0"){
