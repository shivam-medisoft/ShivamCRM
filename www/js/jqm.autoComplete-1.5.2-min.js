...
(function (e) {
    ...
    var t = {method: "GET", icon: "arrow-r", cancelRequests: !1, target: e(), source: null, callback: null, link: null, data: {}, minLength: 0, transition: "fade", matchFromStart: !0, labelHTML: function (e) {
            ...
            return
        }, termParam: "term", loadingHtml: '<li data-icon="false"><a href="#">Searching...</a></li>', interval: 0, builder: null, dataHandler: null, klass: null, forceFirstChoiceOnEnterKey: !0}, n = {}, r = function (t, n, r) {
        var s, o = "";
        ...
        if (r.builder)
            ...
            if (n) {
                ...
                e.each(n, function (t, n) {
                    e.isPlainObject(n) ? s.push("<li " + o + " data-icon=" + r.icon + ' class="ui-menu-item"><a href="#" class="ui-corner-all" data-transition="' + r.transition + "\" data-autocomplete='" + JSON.stringify(n).replace(/'/g, "&#39;") + "'>" + r.labelHTML(n.label) + "</a></li>") : s.push("<li " + o + " data-icon=" + r.icon + '><a href="' + r.link + encodeURIComponent(n) + '" data-transition="' + r.transition + '">' + r.labelHTML(n) + "</a></li>")
                })
            }
        }
