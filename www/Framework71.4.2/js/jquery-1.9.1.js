...
function notifymsg(msg) {
	...
	var exitappname = "Shivam Dashboard";
                                    if (localStorage.appname === 'fernandez') {
                                        exitappname = "Feranandez- New Notification";
                                    } else if (localStorage.appname === 'patel') {
                                        exitappname = "Patel Hospital- New Notification";
                                    } else if (localStorage.appname === 'bvc') {
                                        exitappname = "Bellevue Clinic- New Notification";
                                    } else if (localStorage.appname === 'ankura') {
                                        exitappname = "Ankura Hospital- New Notification";
                                    } else if (localStorage.appname === 'mah') {
                                        exitappname = "Maharaja Agrasen Hospital- New Notification";
                                    }
                                    else if (localStorage.appname === 'kbh') {
                                        exitappname = "Kamalnayan Bajaj Hospital- New Notification";
                                    }else if (localStorage.appname === 'zoi') {
                                        exitappname = "Zoi Hospitals- New Notification";
                                    }else if (localStorage.appname === 'johal') {
                                        exitappname = "Johal Hospitals- New Notification";
                                    }
        playBeepn();
